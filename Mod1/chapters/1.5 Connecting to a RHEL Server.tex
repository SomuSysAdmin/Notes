...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{"Mod1/chapters/1.5.a Server auth"}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{"Mod1/chapters/1.5.b Client auth with no password"}
